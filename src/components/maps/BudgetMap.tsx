...
const YearControl = ({ year, setYear }: { year: number; setYear: (year: number) => void }) => {
  return (
...
const districtStyle = (feature: any, year: number) => {
  const budget = feature.properties[`budget${year}`];
  return {
        ...
        <div className="map-container">
          ...
          >
            ...
            <GeoJSON 
              ...
              style={(feature) => districtStyle(feature, year)}
