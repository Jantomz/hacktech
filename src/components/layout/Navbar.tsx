      ...
      {user ? (
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <div className="h-9 w-9 rounded-full bg-budget-primary flex items-center justify-center">
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem className="cursor-pointer" onClick={() => handleNavigation('/upload')}>
              Upload Documents
            </DropdownMenuItem>
